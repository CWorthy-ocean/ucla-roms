...
!----------------------------------------------------------------------
      ...
      if (pio_gtype /= '----') then
        if (present(start)) then
          irec = start(2)
          call pio_ncwrite1(vname, dat, irec)
        else
          call pio_ncwrite1(vname, dat)
        endif
        return
      endif
      else
...
!----------------------------------------------------------------------
      ...
      if (pio_gtype /= '----') then
        if (present(start)) then
          irec = start(3)
          call pio_ncwrite2(vname, dat, irec)
        else
          call pio_ncwrite2(vname, dat)
        endif
        return
      endif
      else
...
!----------------------------------------------------------------------
      ...
      if (pio_gtype /= '----') then
        if (present(start)) then
          irec = start(4)
          call pio_ncwrite3(vname, dat, irec)
        else
          call pio_ncwrite3(vname, dat)
        endif
        return
      endif
      else
