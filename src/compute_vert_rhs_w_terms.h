...
!  Fz(k+1/2) = w(k+1/2)*0.5_8(We(i,j,k+1)+We(i,j,k))
!  w(k+1/2) =  0.5_8*(w(i,j,k+1)+w(i,j,k)) - 0.166666_8*curv
!  at k+1/2: add curv(k..k+2) if w<0 otherw add curv(k-1._8..k+1)
...
do k=1,N
  do i=istr,iend
    ...
    &-0.1666666666666666_8*( curv(i,k-1)*max(Flxw,0._8)&
    &+curv(i,k  )*min(Flxw,0._8))
  enddo
enddo
