...
#include "cppdefs.opt"
     ...
     &     ialk_alt, idic, idic_alt, nr_marbl_ss_3d,
     &     vname_marbl_ss_3d
     ...
     &     dn_tm, dn_xr, dn_yr, dn_zr, create_file, sec2date
     ...
     &                   cdr_jloc
      ...
      integer :: nrpf   = 4     ! number of frames per file
...
!     Allocate and initialize arrays.
     ...
     &        info=
     &     "`cdr_monthly_avg` is .true., but `wrt_cdr_avg` is .false.")
      endif
