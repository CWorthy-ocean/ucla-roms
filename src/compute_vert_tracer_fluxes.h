...
# endif
  ...
  do i=istr,iend
# if defined NEUMANN_TS
    FC(i,N)=(3._8*t(i,j,N,nrhs,itrc)-FC(i,N-1))/(2._8-CF(i,N))
# else
    FC(i,N)=(2._8*t(i,j,N,nrhs,itrc)-FC(i,N-1))/(1._8-CF(i,N))
# endif
  enddo
  ...
  do i=istr,iend
    FC(i,N)=0._8                         ! Set top and bottom
  ...
  do i=istr,iend
    ...
    &)
    FC(i,N-1)=We(i,j,N-1)*(     0.5_8*t(i,j,N  ,nrhs,itrc)&
    &+0.58333333333333_8*t(i,j,N-1,nrhs,itrc)&
    &-0.08333333333333_8*t(i,j,N-2,nrhs,itrc)&
    &)
    FC(i,N )=0.0_8
  enddo
#endif
