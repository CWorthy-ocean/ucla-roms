...
!-----------------------------------------------------------------------
    ...
    do itrc=1,nr_marbl_ss_2d
      ...
      &marbl_saved_state_2d(i0:i1,j0:j1,itrc),start,.true.)
    enddo
#else
    ! Add MARBL saved_state variables to restart file
    start=1; start(4)=rec_rst
