...
! netcdf outputting:
      ...
      integer :: record_avg = 0           ! Triggers making of initial file
      integer :: record_his = 0
      integer :: record_dia_avg = 0   ! Triggers making of initial file
      integer :: record_dia_his = 0
...
! ----------------------------------------------------------------------
      ...
      use bgc_forces, only: dust, iron, pco2air
#ifdef MARBL
     &     , pco2air_alt
#endif
#ifdef NOX_FORCING
