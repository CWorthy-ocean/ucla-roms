...
#include "cppdefs.opt"
     ...
     &   pio_file_is_open, pio_frcfile
      ...
      real,parameter :: eps=1e-2 ! prevent rounding error failures in get_frc_data
...
!    &                                      ,zdimw= 's_w    '
      ...
      integer :: xc_,xc0,xc1,yc_,yc0,yc1
      integer :: iSWc,jSWc
      integer :: nxc,nyc
     ...
     &     public::diagnostic_opt='diagnostics OFF'
      ...
      integer :: irec_stride
      integer :: ifile_stride
      integer, public :: ifile_max_recs(max_frc_files)
...
!     ----------------------------------------------------------------------
      ...
      integer ::  namelist_unit, ios, lstr, testunit
...
!     integer :: nxc,nyc
      ...
      integer :: off_x,off_y
      integer :: iwestc, ieastc, jsouthc, jnorthc
...
! ----------------------------------------------------------------------
      ...
      real    :: dummy_modtime=0  ! a dummy variable that does nothing
      logical :: d1
      integer :: bry
...
! input/outputs
      ...
      real,dimension(:,:,:),intent(out)   :: var3d ! time interpolated forcing data
      integer,optional,   intent(in)    :: obry  ! bry=1, suppress terminal info, bry=2 display boundary
