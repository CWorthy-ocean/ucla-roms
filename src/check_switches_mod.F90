...
#include "cppdefs.opt"
  ...
  public :: check_tiling
  public :: check_tile_bounds
  public :: print_switches
  public :: check_switches2
...
contains
  ...
  subroutine check_tiling () ! dimensions of the grid and
    ...
    integer(kind=4) tile                   ! logic of the code requires
    ...
    call error_log%abort_check()        ! incorrectly may result in
  end subroutine check_tiling                                  ! smaller size.
  ...
  subroutine check_tile_bounds (tile)
    ...
    integer(kind=4) tile, isize,jsize
#include "compute_tile_bounds.h"
  ...
  end subroutine check_tile_bounds
...
! the error flag.
    ...
    integer(kind=4) is,ie, i,nwd, lbffr(3)
...
1   format(T8,A,T32,A,T56,A)       ! most 24-character-wide and fit
  end subroutine print_switches                            ! it into 80-character width.
...
! contradictions (if any), and raise errors flag to terminate the run.
    ...
    character(len=1024) :: error_info
    integer(kind=4) nobc_west, nobc_east, nobc_south, nobc_north, &
    &                                ncoupl, nAk, is,ie
...
! set-up.
  ...
  end subroutine check_switches2
end module check_switches_mod
