...
- Prior to this PR the passive tracers would not have been written to the output files correctly (`#314 <https://github.com/CWorthy-ocean/ucla-roms/pull/314>`_)
- The fact that this variable was not present may be the cause of some recent trouble with PIO extract_data writes. (`#318 <https://github.com/CWorthy-ocean/ucla-roms/pull/318>`_)
...
- Passive tracers are expected to be named passive_tracer1, passive_tracer2, etc.   (Will be different for the CDR tracers) (`#314 <https://github.com/CWorthy-ocean/ucla-roms/pull/314>`_)
